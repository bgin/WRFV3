...
MODULE module_mp_nssl_2mom
  ...
  real   , private :: esstem1 = -10.  
  real   , private :: esstem2 = -07.  
 ...
 1100 continue
     ...
     &                               ) then
      ...
      ELSE
        ...
        ess(mgs) = ess0*Exp(ess1*(esstem2) )*(temcg(mgs) - esstem1)/5. 
     ...
     &  , qrmxd(mgs))
       ...
       ELSEIF ( ipconc .ge. 3 ) THEN
         ...
         IF ( ibiggopt == 2 .and. imurain == 1 ) THEN 
           ...
           IF ( dbigg < Max(dfrz,dhmn) .and. ( ibiggsnow == 1 .or. ibiggsnow == 3 ) ) THEN 
