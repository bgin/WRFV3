...
print *,'INFMAX,INFMAX1,HYDRO(1)*SOILIQW(1),-TOTLIQ', &
  ...
  10   I1=I
   ...
   1   PRINT *,'     AVOST IN VILKA     Table index= ',I
       ...
       CALL wrf_error_fatal3("module_sf_ruclsm.b",6386,&
'  Crash in surface energy budget  ' )
 ...
 IF(.not.restart)THEN
   ...
   IF ( errflag .EQ. 1 ) THEN
      CALL wrf_error_fatal3("module_sf_ruclsm.b",6967,&
  ...
  END SUBROUTINE ruclsminit
       ...
       IF ( wrf_dm_on_monitor() ) THEN
        ...
        IF(ierr .NE. OPEN_OK ) THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",7103,&
message )
        END IF
 ...
 2000   FORMAT (A8)
        ...
        IF (LUMATCH == 1) then
           ...
           if ( ierr /= 0 ) call wrf_error_fatal3("module_sf_ruclsm.b",7170,&
"Problem read URBAN from VEGPARM.TBL")
 ...
 2002   CONTINUE
    ...
    ENDIF
        ...
        IF (LUMATCH == 0) then
           CALL wrf_error_fatal3("module_sf_ruclsm.b",7184,&
"Land Use Dataset '"//MMINLURUC//"' not found in VEGPARM.TBL.")
      ...
      IF ( wrf_dm_on_monitor() ) THEN
        ...
        IF(ierr .NE. OPEN_OK ) THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",7223,&
message )
        END IF
 ...
 2003   CONTINUE
      ...
      IF(LUMATCH.EQ.0)THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",7284,&
'INCONSISTENT OR MISSING SOILPARM FILE' )
      ...
      IF ( wrf_dm_on_monitor() ) THEN
        ...
        IF(ierr .NE. OPEN_OK ) THEN
          ...
          CALL wrf_error_fatal3("module_sf_ruclsm.b",7296,&
message )
        END IF
